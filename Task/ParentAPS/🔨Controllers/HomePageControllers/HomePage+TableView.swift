...
extension HomePage : UITableViewDelegate ,UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        weatherViewController.locationModel = LocationModel(citiyName: citiesArray[(indexPath as NSIndexPath).row].citiyName.removeWhitespace(), ISOcountryCode:citiesArray[(indexPath as NSIndexPath).row].ISOcountryCode )
